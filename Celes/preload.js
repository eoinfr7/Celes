...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  moveSongInPlaylist: (playlistId, songId, newIndex) => ipcRenderer.invoke('move-song-in-playlist', playlistId, songId, newIndex),
  ...
  getExploreSections: () => ipcRenderer.invoke('get-explore-sections'),
